...
class Flat
{
    ...
    //point_cloud_topic_ = "/ros2pcl/foothold_region";
    ...
    {
        point_cloud_topic_ = "/ros2pcl/foothold_region";
        if(nh_.hasParam("/flat2/point_cloud_topic_")) {
            nh_.getParam("/flat2/point_cloud_topic_", point_cloud_topic_);
        }
        frame_id_ = "/aidinvi_body";
        if(nh_.hasParam("/flat2/frame_id_")) {
            nh_.getParam("/flat2/frame_id_", frame_id_);
        }
    ...
    pcl::PointCloud<PointT>::Ptr normal_determine(pcl::PointXYZ normal_point, std::vector<double> normal_vector, pcl::PointCloud<PointT>::Ptr flat_cloud2) {
        ...
        if(normal_cos > cos(flat_angle/180*pi)) { //flat
    ...
    void flatcalculate(pcl::PointCloud<PointT> &rawpointcloud)
    {
        ...
        flat_cloud->header.frame_id = frame_id_;
